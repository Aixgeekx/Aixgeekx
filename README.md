...
| Approach | How it shows up in projects |
| :-- | :-- |
| **Cross-domain integration** | Built intelligent vehicles combining LiDAR, CV, and chassis control; built FPGA debuggers bridging protocol logic, signal processing, and host software.<br /><sub>智能车项目融合激光雷达、视觉与底盘控制；FPGA 调试器打通协议逻辑、信号处理与上位机软件。</sub> |
| **From first prototype to deployed system** | Took industrial defect detection from raw camera input through model training, lightweighting, embedded deployment, to a live web dashboard.<br /><sub>工业缺陷检测从摄像头采集、模型训练、轻量化、嵌入式部署到 Web 看板全流程落地。</sub> |
| **System-level debugging** | Trace failures across hardware signals, firmware logic, protocol layers, and software interfaces instead of treating each layer in isolation.<br /><sub>跨硬件信号、固件逻辑、协议层和软件界面定位问题，而非逐层孤立排查。</sub> |
| **Delivering under constraints** | Ship working systems within competition deadlines and hardware budgets, balancing performance, cost, and schedule.<br /><sub>在竞赛周期和硬件预算内交付可用系统，平衡性能、成本与进度。</sub> |
...
<table>
  <tr>
    <td width="50%">
      ...
      本科组二等奖 · 2025.05<br />
      <img src="https://img.shields.io/badge/Award-National%20Second%20Prize-F59E0B?style=flat-square" alt="National second prize" /> <img src="https://img.shields.io/badge/Field-Statistical%20Modeling-2563EB?style=flat-square" alt="Statistical modeling" />
    </td>
    <td width="50%">
      <strong>全国大学生数学建模大赛</strong><br />
      国家三等奖 · 2025.06<br />
      <img src="https://img.shields.io/badge/Award-National%20Third%20Prize-14B8A6?style=flat-square" alt="National third prize" /> <img src="https://img.shields.io/badge/Field-Mathematical%20Modeling-2563EB?style=flat-square" alt="Mathematical modeling" />
    </td>
  </tr>
  <tr>
    <td width="50%">
      ...
      2025.07<br />
      <img src="https://img.shields.io/badge/Field-Electronic%20Design-14B8A6?style=flat-square" alt="Electronic design" /> <img src="https://img.shields.io/badge/Scope-Circuit%20%2B%20System-111827?style=flat-square" alt="Circuit and system" />
    </td>
    <td width="50%">
      <strong>全国大学生服务外包创新创业大赛</strong><br />
      国家三等奖 · 2025.07<br />
      <img src="https://img.shields.io/badge/Award-National%20Third%20Prize-14B8A6?style=flat-square" alt="National third prize" /> <img src="https://img.shields.io/badge/Field-Service%20Outsourcing%20%2B%20Innovation-22C55E?style=flat-square" alt="Service outsourcing innovation" />
    </td>
  </tr>
  <tr>
    <td colspan="2" align="center">
      ...
      国家三等奖 · 2025.11<br />
      <img src="https://img.shields.io/badge/Award-National%20Third%20Prize-14B8A6?style=flat-square" alt="National third prize" /> <img src="https://img.shields.io/badge/Field-FPGA%20Innovation%20Design-2563EB?style=flat-square" alt="FPGA innovation design" /> <img src="https://img.shields.io/badge/Platform-Gowin%20FPGA-111827?style=flat-square" alt="Gowin FPGA" />
    </td>
  </tr>
</table>
